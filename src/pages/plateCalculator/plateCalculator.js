...
const PlateCalculator = () => {
  ...
  const components = [<PipeByPlane />, <PipeByPipe />, <PipeByCone />, <ConcentricFrustum />, <EccentricFrustum />, <RectToRound />];
    ...
    <div className="card_container">
      <div>
        ...
        <div className="pagination">
          ...
          <span className="page_no">{pageNo + 1}/6</span>
          <button onClick={handleNext} disabled={currentComponent === 5} className="next_button">
            Next Geometry
          </button>
        </div>
      </div>
